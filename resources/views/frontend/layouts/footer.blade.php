@section('footer')
    ...
    <footer>
        <div class="footer-top">
            <div class="container">
                <div class="row">
                    <div class="col-sm-5">
                        <img src="{{url('frontend/assets/images/logo.svg')}}" class="footer-logo" alt=""/>
    ...
    <script src="{{url('frontend/assets/vendors/aos/dist/aos.js/aos.js')}}"></script>
    <!----------------------------------- End plugin js for this page ----------------------->
    <!------------------------------------ Custom js for this page --------------------------->
    <script src="{{url('frontend/assets/js/demo.js')}}"></script>
    <script src="{{url('frontend/assets/js/jquery.easeScroll.js')}}"></script>
